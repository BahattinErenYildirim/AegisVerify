...
BACKEND_URL = os.getenv("BACKEND_URL", "http://localhost:8000") # Backend URL is essential for UcanbleHub, if you change it unfortunately UcanbleHub may not execute your requests properly.
